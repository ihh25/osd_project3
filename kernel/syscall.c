...
//  extern 변수는 다른 파일의 전역 변수를 사용하고자 할 때 사용
//이 sys_어쩌구 함수들이 kernal/sysproc.c에 있음
...
// 함수 포인터 배열의 index번째 원소에 해당하는 함수의 주소를 연결함
